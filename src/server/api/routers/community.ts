...
import { z } from "zod";
import { fetchAllCommunities, fetchCommunitiesByQueryInfinite, fetchCommunitybyID } from "~/lib/data";
...
export const communityRouter = createTRPCRouter({
    ...
    .query(async ({input}) => {
        try{
            ...
            const { allCommunities, nextCursor, hasNextPage } = await fetchCommunitiesByQueryInfinite(cursor, limit , search)
