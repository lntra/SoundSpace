...
const CommunityDisplaySearch : NextPage  = () => {
    ...
    return <>
        ...
        <div className={`${dark ? "bg-gray-900" : "bg-sp-tp-page"}`}>
            <div className={`grid grid-rows-auto grid-cols-10 w-[100%] ${dark ? "bg-gray-900" : "bg-sp-tp-page"}`}>
                <div className="w-[100%] min-h-[71vh] col-span-12 sm:col-start-2 sm:col-end-10 md:col-start-3 md:col-end-9 mt-4">
                        <div>
