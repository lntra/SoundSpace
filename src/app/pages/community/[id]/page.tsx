...
const CommunityPage: NextPage = () => {
  ...
  const isFollowedStart = followedCommunities.some(
    (followedCommunity) => followedCommunity.id === id,
  );
          ...
          <div
            className={`${
              dark
                ...
                : "bg-gradient-to-b from-sp-tp-page to-indigo-50"
            }`}
          >
            {data && (
              <>
                <CommunityBanner
                  ...
                  followings={
                    isFollowed
                      ? Number(data.communityPage[0]?.followings) + 1
                      : data.communityPage[0]?.followings
                  }
                ...
                {!!isFollowed && data.communityPage[0] && userData && (
                  <div className="grid-rows-auto grid w-[100%] grid-cols-12">
                    <div className="col-start-2 col-end-12 sm:col-span-6 sm:col-start-4 xl:col-start-5 xl:col-end-9">
                      <TextAreaPost
