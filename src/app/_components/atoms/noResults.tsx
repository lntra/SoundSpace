...
const NoResults = ({ dark, text }: NoResultsProps) => {
  return (
    <>
      <div
        className={`${
          !dark === true ? "opacity-70" : "opacity-70"
        } flex h-full flex-col items-center justify-center rounded-3xl  border-sp-purpleBright2 align-middle`}
      >
        <div className="w-48">
          <svg
        ...
        <h1
          className={`p-4 text-2xl font-bold ${
            !dark === true ? "text-sp-purpleBright2" : "text-sp-accent"
          }`}
        >
