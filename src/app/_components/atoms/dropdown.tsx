...
const DropdownBar = ({ name, image, id, dark }: DropdownBarProps) => {
  ...
  const handleClickOutside = (e: MouseEvent) => {
    if (
      ...
      dropdownStateNotification.current &&
      !dropdownStateNotification.current.contains(e.target as Node)
    ) {
      setNav(false);
  ...
  return (
    <>
      <button onClick={() => setNav(!nav)} className="cursor-pointer">
        ...
        >
          <path
            d="M8 12C8 10.8954 8.89543 10 10 10H38C39.1046 10 40 10.8954 40 12C40 13.1046 39.1046 14 38 14H10C8.89543 14 8 13.1046 8 12Z"
            fill={`${dark ? "#a585cc" : "#53337B"}`}
          />
          <path
            d="M8 20C8 18.8954 8.89543 18 10 18H38C39.1046 18 40 18.8954 40 20C40 21.1046 39.1046 22 38 22H10C8.89543 22 8 21.1046 8 20Z"
            fill={`${dark ? "#a585cc" : "#53337B"}`}
          />
          <path
            d="M8 28C8 26.8954 8.89543 26 10 26H38C39.1046 26 40 26.8954 40 28C40 29.1046 39.1046 30 38 30H10C8.89543 30 8 29.1046 8 28Z"
            fill={`${dark ? "#a585cc" : "#53337B"}`}
          />
          <path
            d="M8 36C8 34.8954 8.89543 34 10 34H38C39.1046 34 40 34.8954 40 36C40 37.1046 39.1046 38 38 38H10C8.89543 38 8 37.1046 8 36Z"
            fill={`${dark ? "#a585cc" : "#53337B"}`}
          />
        </svg>
      </button>
      ...
      <div
        ...
        className={
          nav
            ? "fixed left-0 top-0 z-50 h-screen w-[100vw] bg-sp-purple duration-300 sm:w-[300px]"
            : "fixed left-[-105%] top-0 z-50 h-screen w-[100vw] bg-sp-purple duration-300 sm:w-[300px]"
        }
      >
        <button
          onClick={() => {
        ...
        >
          ...
          >
            <path
              ...
              style={{ fill: "var(--path-fill-color, white)" }}
            />
          </svg>
        </button>
        <div
          className={`flex h-[100vh] flex-col justify-start px-6 pt-3  text-white`}
        >
          <div className="flex flex-row border-b-[1px] border-solid border-sp-accent pb-3 ">
            ...
            <div className="flex flex-col justify-center pl-2">
              ...
              <Link href={`/pages/profile/${id}`}>
                <p className="group cursor-pointer text-lg font-bold transition-colors duration-200 hover:text-sp-accent">
                  {name}
                </p>
              </Link>
            </div>
          ...
          <Link href="/pages/community" prefetch={false}>
            <div className="group flex flex-wrap border-b-[1px] border-solid border-sp-accent py-5 transition-colors duration-200 hover:text-sp-accent">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
              ...
              >
                <path
                  className="duration-200-hover:fill-sp-accent group transition-colors"
          ...
          <div
            ...
            className="group flex cursor-pointer  flex-wrap border-b-[1px] border-solid border-sp-accent py-5 align-middle transition-colors duration-200 hover:text-sp-accent"
          >
            <svg
              width="24"
              height="24"
            ...
            {hasUnseenNotifications && (
              <div className="ring-container flex scale-75 items-center justify-center">
          ...
          <div className="mt-auto" onClick={handleLogOut}>
            <div className="group flex flex-wrap items-center justify-center border-t-[1px] border-solid border-sp-accent py-5 transition-colors duration-200 hover:border-red-500 hover:text-red-500">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
              ...
              >
                <path
                  ...
                  style={{ fill: "var(--path-fill-colorDisconnect, white)" }}
                />
              </svg>
      ...
      <div
        ...
        className={
          navNotification
            ? "fixed left-[25vw] top-[153px] z-50 h-[660px] w-[75%] overflow-hidden rounded-3xl border-x-[1px] border-y-[1px] border-l-[1px] border-sp-accent border-l-sp-accent bg-sp-purple p-3 px-3 duration-300 sm:left-[300px] sm:w-[300px]  sm:rounded-l-none sm:rounded-r-3xl sm:border-y-[1px] sm:border-r-[1px] sm:border-l-[#432d65] "
            : "fixed left-[-100%] top-[153px] z-10 h-[660px] w-[300px] bg-sp-purple duration-300"
        }
      >
