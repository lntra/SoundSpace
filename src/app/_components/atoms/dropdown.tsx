...
const DropdownBar = () => {
    ...
    return <>
        ...
        <div 
                ...
                className={
                    nav
                        ? "fixed top-0 left-0 w-[300px] h-screen bg-sp-purple z-50 duration-300"
                        : "fixed top-0 left-[-100%] w-[300px] h-screen bg-sp-purple z-50 duration-300"
                }>
            ...
            <div className="flex flex-col px-6 pt-3 justify-start h-[100vh]">
                <div className="flex flex-row pb-3 border-solid border-b-[1px] border-sp-accent ">
                    ...
                    <div className="flex flex-col justify-center pl-2">
                        ...
                        <p className="font-bold text-lg cursor-pointer hover:text-sp-accent group transition-colors duration-200">AlexEclipse</p>
                    </div>
                </div>
                ...
                <Link href="/pages/home" prefetch={false}>
                    <div className="flex flex-wrap py-5 border-solid border-b-[1px] border-sp-accent hover:text-sp-accent group transition-colors duration-200">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 4C7.6 4 4 7.6 4 12C4 16.4 7.6 20 12 20C16.4 20 20 16.4 20 12C20 7.6 16.4 4 12 4ZM13 17H11V10H13V17ZM13 9H11V7H13V9Z" style={{ fill: 'var(--path-fill-color, white)' }}/>
                        </svg>
