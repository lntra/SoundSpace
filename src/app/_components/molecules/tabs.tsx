const Tabs = () => {
    return <>
        <div className="ml-5 col-start-1 col-end-12 row-start-1 row-end-2 flex flex-row w-[100%] min-h-[70px]">
            ...
            <span className=" w-full border-b-2 border-sp-purpleBright2"></span>
        </div>
    </>
}
