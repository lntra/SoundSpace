...
const ConfigButton = ( {user} : ConfigButtonProps ) =>{
    return <>
        <Link className="w-full flex justify-center" href={`/pages/profile/${user}/settings`}>
            <button className="py-2.5 px-5 min-w-[50%] flex items-center justify-center text-center border-solid border-[3px] rounded-[25px] border-sp-purpleBright2 hover:bg-sp-accent hover:border-sp-accent hover:outline-offset-8 hover:transition">
                <svg width="25" className="min-h-[24px] min-w-[25px]" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="hidden md:flex text-base font-bold">Settings</p>
            </button>
        </Link>
    </>
}
