const ConfigButton = () =>{
    return <>
        <button className="py-2.5 px-5 w-[75%] flex items-center justify-center text-center border-solid border-[2px] rounded-[20px] border-sp-purpleBright2 hover:bg-sp-purpleBright2 hover:transition">
